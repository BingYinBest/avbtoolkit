...
import dev.vbmeta.studio.ui.component.material.SegmentedColumn
...
import dev.vbmeta.studio.ui.component.material.SendLogBottomSheet
import dev.vbmeta.studio.ui.component.material.SnackBarHost
    ...
    Card(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Button(onClick = actions.onToolchainInit) {
                    Text(stringResource(R.string.settings_toolchain_init))
                }
                OutlinedButton(onClick = actions.onToolchainSelfCheck) {
                    Text(stringResource(R.string.settings_toolchain_selfcheck))
                }
                OutlinedButton(onClick = actions.onToolchainClear) {
